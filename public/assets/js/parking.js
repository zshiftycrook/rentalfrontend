   ...
   $.ajax({
     ...
     success:  async function(result){
      ...
      if (pdiffmonth<0)
      {
        ...
        document.getElementById("month").max=(0)
      ...
      else
      {
        ...
        if(pdiffmonth==0){
          document.getElementById("month").max=(1)

        }
        else{
        document.getElementById("month").max=(pdiffmonth)
        }
       ...
       //document.getElementById("total").value=document.getElementById("month").value*500;
       //if (document.getElementById("month").value == ''){document.getElementById("total").value=0;}
